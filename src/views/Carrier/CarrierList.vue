  ...
  <div class="catagorey-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Crriers name "> </a-input>
        </a-form-item>
      ...
      >
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/carriers/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/carriers/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
...
const columns = [
  {
    ...
    key: "name",
    sorter: true,
    scopedSlots: { customRender: "Crriers Name" },
  },
  {
    title: "Active Status",
    dataIndex: "",
