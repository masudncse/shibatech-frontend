      ...
      <a-row>
        ...
        <a-col :span="12" align="end">
          <a-button
            type="primary"
            icon="plus"
            @click="$router.push('/carriers/add')"
            >Add Crrier</a-button
          >
          <div class="mb-2"></div>
          <a-button @click="$router.push('/carriers/1/edit')">Edit</a-button>
          <a-button class="ml-2">Send Email</a-button>
          <a-dropdown>
            <a-menu slot="overlay">
              <a-menu-item key="1"> Delete Crriers </a-menu-item>
