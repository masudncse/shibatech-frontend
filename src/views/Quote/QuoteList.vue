  ...
  <div class="vendor-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Quote "> </a-input>
        </a-form-item>
    ...
    >
      ...
      >
        ...
        <a slot="Quote Stage" slot-scope="text">{{ text }}</a>
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/quotes/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/quotes/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
...
const columns = [
  ...
  },
  {
    ...
    key: "stage",
    sorter: true,
    scopedSlots: { customRender: "Quote Stage" },
  },
  {
    title: "Shipping",
    dataIndex: "shipping",
