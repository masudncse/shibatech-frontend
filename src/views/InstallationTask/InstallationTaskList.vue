<template>
  <div class="Installationtasks-list">
    <a-row>
      <a-col :span="12">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="installationtasks "> </a-input>
        </a-form-item>
      ...
      >
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/installation-tasks/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/installation-tasks/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
