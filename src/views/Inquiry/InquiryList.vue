  ...
  <div class="vendor-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Inquiry "> </a-input>
        </a-form-item>
    ...
    >
      ...
      >
        ...
        <a slot="Inquiry Stage" slot-scope="text">{{ text }}</a>
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/inquiries/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/inquiries/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
...
const columns = [
  ...
  },
  {
    ...
    key: "stage",
    sorter: true,
    scopedSlots: { customRender: "Inquiry Stage" },
  },
  {
    title: "Shipping",
    dataIndex: "shipping",
