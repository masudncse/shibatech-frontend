    ...
    >
      <a-row>
        ...
        <a-col :span="12" align="end">
          ...
          >
          <div class="mb-2"></div>
          <a-button @click="$router.push('/permissions/1/edit')">Edit</a-button>
          <a-button class="ml-2">Send Email</a-button>
          <a-dropdown>
            <a-menu slot="overlay">
              <a-menu-item key="1"> Delete Permission </a-menu-item>
      ...
      <a-form :form="form" :label-col="{ span: 6 }" :wrapper-col="{ span: 12 }">
        <a-card title="Basic Information">
          <a-row :gutter="15">
            ...
            <a-col :span="12">
              <a-form-item label="Permission Status" labelAlign="left" class="mb-1">
                Active
              </a-form-item>
            </a-col>
            <a-col :span="12">
