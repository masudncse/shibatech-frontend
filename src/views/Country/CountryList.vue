    ...
    <a-row>
      <a-col :span="12">
        <a-breadcrumb class="page--title">
          ...
          <a-breadcrumb-item
            ><router-link to="/country/all">Country all</router-link></a-breadcrumb-item
          >
      ...
      >
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/country/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/country/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
