  ...
  <div class="catagorey-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Task Priritye "> </a-input>
        </a-form-item>
    ...
    >
      ...
      >
        ...
        <a slot="Task Pririty" slot-scope="text">{{ text }}</a>
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/task-priorities/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/task-priorities/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
...
const columns = [
  {
    ...
    key: "name",
    sorter: true,
    scopedSlots: { customRender: "Task  Pririty" },
  },
  {
    title: " Color ",
    dataIndex: "Color",
