        ...
        <div class="page--title">
          <a-breadcrumb>
            ...
            <a-breadcrumb-item
              ...
              ></a-breadcrumb-item
            >
            <a-breadcrumb-item>Editing : ABC Comp...</a-breadcrumb-item>
          </a-breadcrumb>
          <a-page-header
            title="Editing Organization - ABC Company"
            sub-title=""
          />
        </div>
      </a-col>
            ...
            <a-col :span="12">
              <a-form-item label="Industry " labelAlign="left" class="mb-0">
                <a-select default-value="Banking" style="width: 120px">
                  ...
                  <a-select-option value="Communnication">
                    Communnication
                  </a-select-option>
            ...
            <a-col :span="12">
              <a-form-item label="Rating " labelAlign="left" class="mb-0">
                <a-select default-value="Active" style="width: 120px">
                  ...
                  <a-select-option value="Project Cancelled">
                    Project Cancelled
                  </a-select-option>
