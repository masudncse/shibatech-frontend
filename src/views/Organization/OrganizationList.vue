  ...
  <div class="organization-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Organization Name"> </a-input>
        </a-form-item>
        <a-form-item>
    ...
    >
      ...
      >
        ...
        <a slot="website" slot-scope="text">{{ text }}</a>
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/organizations/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/organizations/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
