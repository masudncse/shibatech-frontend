  ...
  <div class="vendor-list">
    <a-row>
      <a-col :span="12">
        <a-breadcrumb class="page--title">
          ...
          <a-breadcrumb-item
            ><router-link to="/installation-works">Installation Works</router-link></a-breadcrumb-item
          >
      ...
      <a-col :span="12" align="end">
        <a-button
          ...
          icon="plus"
          class="mt-2"
          @click="$router.push('/installation-works/add')"
          >Add Installation Work</a-button
        >
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Installation Work Name"> </a-input>
        </a-form-item>
        <a-form-item>
      ...
      >
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/installation-works/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/installation-works/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
...
const data = [
  {
    id: "1",
    name: "Installation Work 1",
    phone: "01676717945",
    email: "example@gmail.com",
  },
  {
    id: "2",
    name: "Installation Work 2",
    phone: "01676717945",
    email: "example@gmail.com",
  },
];
