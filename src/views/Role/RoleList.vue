  ...
  <div class="role-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Role Name"> </a-input>
        </a-form-item>
        <a-form-item>
    ...
    >
      ...
      >
        <span style="width: 100px" slot="selection-column" slot-scope="text">{{ text }}</span>
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/roles/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/roles/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
