      ...
      <a-col :span="24">
        <a-breadcrumb class="page--title">
          ...
          <a-breadcrumb-item
            ...
            ></a-breadcrumb-item
          >
          <a-breadcrumb-item>Category 1</a-breadcrumb-item>
        </a-breadcrumb>
      </a-col>
    </a-row>
      ...
      <a-row>
        ...
        <a-col :span="12" align="end">
          <a-button
            type="primary"
            icon="plus"
            @click="$router.push('/product-categories/add')"
            >Add Category</a-button
          >
          <div class="mb-2"></div>
          <a-button @click="$router.push('/product-categories/1/edit')">Edit</a-button>
