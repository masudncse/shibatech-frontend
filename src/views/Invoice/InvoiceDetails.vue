      ...
      <a-col :span="24">
        <a-breadcrumb class="page--title">
          ...
          <a-breadcrumb-item
            ...
            ></a-breadcrumb-item
          >
          <a-breadcrumb-item>Invoice 1</a-breadcrumb-item>
        </a-breadcrumb>
      </a-col>
    </a-row>
    ...
    >
      <a-row>
        ...
        <a-col :span="12" align="end">
          <a-button @click="$router.push('/invoices/1/edit')">Edit</a-button>
          <a-button class="ml-2">Print Invoice</a-button>
          <a-dropdown>
            <a-menu slot="overlay">
      ...
      >
        <a-card title="Basic Information">
          <a-row :gutter="15">
            ...
            <a-col :span="12">
              <a-form-item label="Invoice Satge" labelAlign="left" class="mb-1">
                Stage 1
              </a-form-item>
            </a-col>
            <a-col :span="12">
