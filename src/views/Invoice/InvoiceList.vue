  ...
  <div class="vendor-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Invoice "> </a-input>
        </a-form-item>
    ...
    >
      ...
      >
        ...
        <a slot="Invoice Stage" slot-scope="text">{{ text }}</a>
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/invoices/${record.id}/details`)"
              icon="info"
            />
            <a-button
              type="default"
...
const columns = [
  ...
  },
  {
    ...
    key: "stage",
    sorter: true,
    scopedSlots: { customRender: "Invoice Stage" },
  },
  {
    title: "Shipping",
    dataIndex: "shipping",
