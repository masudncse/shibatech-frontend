  ...
  <div class="Installationtasks-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="commitiontasks "> </a-input>
        </a-form-item>
      ...
      >
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/commission-tasks/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/commission-tasks/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
