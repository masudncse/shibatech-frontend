        ...
        <div class="page--title">
          <a-breadcrumb>
            ...
            <a-breadcrumb-item
              ...
              ></a-breadcrumb-item
            >
            <a-breadcrumb-item>Editing : Monthly...</a-breadcrumb-item>
          </a-breadcrumb>
          <a-page-header title="Editing Recurring Info - Monthly" sub-title="" />
        </div>
      </a-col>
    </a-row>
      ...
      >
        <a-card title="Basic Information">
          <a-row :gutter="15">
            ...
            <a-col :span="12">
              <a-form-item label=" Strat period" labelAlign="left" class="mb-1">
                <a-input
                  v-decorator="[
                    'Strat Period',
                    {
