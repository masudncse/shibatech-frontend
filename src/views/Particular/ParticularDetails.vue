        ...
        <a-breadcrumb class="page--title">
          ...
          <a-breadcrumb-item
            ><router-link to="/particulars"
              >Particulars</router-link
            ></a-breadcrumb-item
          >
          <a-breadcrumb-item>Particular 1</a-breadcrumb-item>
        </a-breadcrumb>
      </a-col>
    </a-row>
      ...
      <a-row>
        ...
        <a-col :span="12" align="end">
          <a-button
            type="primary"
            icon="plus"
            @click="$router.push('/particulars/add')"
            >Add Particular</a-button
          >
          <div class="mb-2"></div>
          <a-button @click="$router.push('/particulars/1/edit')">Edit</a-button>
          <a-button class="ml-2">Send Email</a-button>
          <a-dropdown>
            <a-menu slot="overlay">
              <a-menu-item key="1"> Delete Particulars </a-menu-item>
