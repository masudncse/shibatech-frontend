  ...
  <div class="catagorey-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Particulars "> </a-input>
        </a-form-item>
      ...
      >
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/particulars/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/particulars/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
...
const columns = [
  ...
  {
    title: "Particulars Discription ",
    dataIndex: "Discription",
    key: "Discription",
    sorter: true,
    scopedSlots: { customRender: "Particulars Discription" },
  },
  {
    title: "Active Status",
    dataIndex: "",
