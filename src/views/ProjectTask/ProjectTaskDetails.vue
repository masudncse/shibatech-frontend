      ...
      <a-row>
        ...
        <a-col :span="12" align="end">
          <a-button
            ...
            >Add Project Tasks</a-button
          >
          <div class="mb-2"></div>
          <a-button @click="$router.push('/project-tasks/1/edit')"
            >Edit</a-button
          >
      ...
      <a-form :form="form" :label-col="{ span: 6 }" :wrapper-col="{ span: 12 }">
        <a-card title="Basic Information">
          <a-row :gutter="15">
            <a-col :span="12">
              <a-form-item
                label="Project Project Task Name "
                labelAlign="left"
                class="mb-1"
              >
                Task 1
            ...
            <a-col :span="12">
              <a-form-item label="Piority " labelAlign="left" class="mb-1">
                Piority 1
              </a-form-item>
            </a-col>
            <a-col :span="12">
            ...
            <a-col :span="12">
              <a-form-item label="Working Hour" labelAlign="left" class="mb-1">
                8 Hour
              </a-form-item>
            </a-col>
            <a-col :span="12">
