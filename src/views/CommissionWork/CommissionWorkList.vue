  ...
  <div class="vendor-list">
    <a-row>
      <a-col :span="12">
        <a-breadcrumb class="page--title">
          ...
          <a-breadcrumb-item
            ><router-link to="/commission-works">Commission Works</router-link></a-breadcrumb-item
          >
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Commission Work Name"> </a-input>
        </a-form-item>
        <a-form-item>
      ...
      >
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/commission-works/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/commission-works/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
