  ...
  <div class="catagorey-list">
    ...
    >
      <a-form layout="inline" @submit.prevent="handleSearch">
        <a-form-item>
          <a-input placeholder="Stages  name "> </a-input>
        </a-form-item>
    ...
    >
      ...
      >
        ...
        <a slot="Sort order" slot-scope="text">{{ text }}</a>
        ...
        <div slot="action" slot-scope="text, record">
          <a-button-group>
            ...
            <a-button
              type="default"
              @click="$router.push(`/inquiry-stages/${record.id}/edit`)"
              icon="edit"
            />
            <a-button
              type="default"
              @click="$router.push(`/inquiry-stages/${record.id}/details`)"
              icon="info"
            />
          </a-button-group>
        </div>
